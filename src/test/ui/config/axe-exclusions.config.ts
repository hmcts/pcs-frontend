export const axe_exclusions = [
  ...
  '#tenancyTypeConfirm-2', //page: tenancyTypeDetails, element: 'No', element_type: radioOption, reason_for_exclusion: 'aria-expanded' attribute is expected for this radio button
];
