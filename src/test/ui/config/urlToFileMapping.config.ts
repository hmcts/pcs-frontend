export default {
  ...
  'counter-claim-upload-files': 'uploadFilesToSupportYourCounterclaim',
  ...
  'counter-claim-do-you-want-to-upload-files': 'doYouWantToUploadFilesToSupportYourCounterclaim',
