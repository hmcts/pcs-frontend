...
test.describe('Respond to claim — ErrorMessageValidation(EMV) journey @nightly @EMV', () => {
  test('RentArrears - Introductory - NoticeServed - Yes and NoticeDateProvided - No - NoticeDetails- Yes - Notice date unknown temp - @regression', async () => {
  ...
  test('NonRentArrears - Secure - NoticeServed - Yes and NoticeDateProvided - Yes - NoticeDetails- Yes - Notice date known @secureFlexible temp- @regression', async () => {
    await softErrorMessageValidation('freeLegalAdvice', freeLegalAdviceErrorValidation);
    await performAction('selectLegalAdvice', freeLegalAdvice.noRadioOption);
