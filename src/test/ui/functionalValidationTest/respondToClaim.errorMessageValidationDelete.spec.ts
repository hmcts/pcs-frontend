...
test.describe('Respond to claim — error message validation @nightly @PR without wrapper', () => {
  test('RentArrears - Introductory - NoticeServed - Yes and NoticeDateProvided - No - NoticeDetails- Yes - Notice date unknown @regression @error', async () => {
    ...
    await defendantNameConfirmationErrorValidation();
    ...
    await correspondenceAddressKnownErrorValidation();
    await performAction('selectCorrespondenceAddressKnown', {
      radioOption: correspondenceAddress.yesRadioOption,
    });

    await contactPreferenceEmailOrPostErrorValidation();
    ...
    await contactPreferencesTelephoneErrorValidation();
    ...
    await tenancyTypeDetailsErrorValidation();
    ...
    await tenancyDateDetailsErrorValidation();
    ...
    await rentArrearsErrorValidation();
    ...
    await repaymentsMadeErrorValidation();
    await performAction('repaymentsMade', {
      question: repaymentsMade.getmainHeader(claimantName),
      repaymentOption: repaymentsMade.noRadioOption,
    });

    await repaymentsAgreedErrorValidation();
    ...
    await doYouHaveAnyDependantChildrenErrorValidation();
    ...
    await doYouHaveAnyOtherDependantsErrorValidation();
    ...
    await doAnyOtherAdultsLiveInYourHomeErrorValidation();
    await performAction('selectIfAnyOtherAdultsLiveInYourHouse', {
      radioOption: doAnyOtherAdultsLiveInYourHome.noRadioOption,
    });

    await wouldYouHaveSomewhereElseToLiveIfYouHadToLeaveYourHomeErrorValidation();
    ...
    await yourCircumstancesErrorValidation();
    ...
    await languageUsedErrorValidation();
  ...
  test('Non-RentArrears - Secure - NoticeServed - Yes and NoticeDateProvided - Yes - NoticeDetails- Yes - Notice date known @secureFlexible @regression @error', async () => {
    ...
    await defendantNameCaptureErrorValidation();
    ...
    await correspondenceAddressErrorValidation();
    ...
    await contactPreferencesTextMessageErrorValidation();
    ...
    await tenancyDateUnknownErrorValidation();
    ...
    await noticeDateWhenProvidedErrorValidation();
    await performAction('enterNoticeDateKnown');

    await nonRentArrearsDisputeErrorValidation();
