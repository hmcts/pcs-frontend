...
export const noticeDateWhenProvided = {
  ...
  backLink: `Back`,
  whenMakingClaimHintText: (claimantName: string) =>
    `When making the claim, ${claimantName} had to say the date they gave you notice (the date of service). If you’re not sure of the exact date, you can find it on the notice.`,
