export const responseSubmittedCounterclaimFeePaymentNeeded = {
  mainHeader: `Response submitted.  You must pay the counterclaim fee`,
  confirmationEmailParagraph: `We’ve sent you a confirmation email.`,
  whatToDoNextHeader: `What to do next`,
  payTheCounterclaimFeeLink: `Pay the counterclaim fee`,
  payTheCounterclaimFeeOpensInNewTabLink: `Pay the counterclaim fee (opens in new tab)`,
  payTheCounterclaimFeeList: `Pay the counterclaim fee. If you do not, your counterclaim will not be considered.`,
