export const doYouHaveAnyDependantChildren = {
  ...
  selectIfYouHaveAnyDependentChildrenErrorMessage: `Select if they have any dependant children`,
  mustBeUnderCharacterLimitErrorMessage: `Dependent children details must be 500 characters or less`,
  saveForLaterButton: `Save for later`,
  backLink: `Back`,
  emojiTextInput: `👉 😄`,
  emojiErrorMessage: `Give details about their dependant children must only include letters a to z, and special characters such as hyphens, spaces and apostrophes`,
  feedbackLink: `feedback`,
  giveDetailsAboutYourDependentChildrenErrorMessage: `Give details about their dependant children`,
