export const disputeClaimInterstitial = {
  ...
  whenTheyMadeTheirClaimParagraph:
    'When they made their claim, Treetops Housing had to give information about:',
  theTenancyList:
    'the tenancy, occupation contract or licence agreement',
  theNoticeOfTheirIntentionList:
    'the notice of their intention to begin possession proceedings, if they served you with one',
  theirGroundsForPossessionList:
    'their grounds for possession (their reasons for making the claim)',
  ...
  theClaimantParagraph:
  'The claimant will be able to see your answers.',
