export const submitCaseApiData = {
  ...
  submitCasePayloadOtherTenancyDate: {
    legislativeCountry: 'England',
    claimantType: {
      value: {
        code: 'PROVIDER_OF_SOCIAL_HOUSING',
    ...
    tenancy_DetailsOfOtherTypeOfTenancyLicence: 'Short term tenancy',
    tenancy_TenancyLicenceDate: '2020-05-20',
    tenancy_TenancyLicenceDocuments: [],
    showIntroductoryDemotedOtherGroundReasonPage: 'Yes',
    introGrounds_HasIntroductoryDemotedOtherGroundsForPossession: 'YES',
    absoluteGrounds: 'test 1',
    otherGround: 'test 2',
    introGrounds_IntroductoryDemotedOrOtherGrounds: ['OTHER', 'ABSOLUTE_GROUNDS'],
    introGrounds_OtherGroundDescription: 'test',
    preActionProtocolCompleted: 'NO',
    mediationAttempted: 'NO',
    settlementAttempted: 'NO',
    noticeServed: 'Yes',
    notice_NoticeServiceMethod: 'FIRST_CLASS_POST',
    notice_NoticePostedDate: '2024-03-20',
    notice_NoticeDocuments: [],
  ...
  submitCasePayloadAssuredTenancyDate: {
    legislativeCountry: 'England',
    claimantType: {
      value: {
        code: 'PROVIDER_OF_SOCIAL_HOUSING',
  ...
  submitCasePayloadSecureTenancy: {
    legislativeCountry: 'England',
    claimantType: {
      value: {
        code: 'PROVIDER_OF_SOCIAL_HOUSING',
