import { counterClaimFee, counterClaimHaveYouAppliedForHelp, dashboard, feedback } from '../data/page-data';
...
export async function counterClaimHaveYouAppliedForHelpNavigationTests(): Promise<void> {
  ...
  await performValidation('pageNavigation', counterClaimHaveYouAppliedForHelp.saveForLaterButton, dashboard.mainHeader);
}
