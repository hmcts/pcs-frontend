import { otherConsiderations } from '../../data/page-data/lr-page-data';
...
export async function otherConsiderationsErrorValidation(): Promise<void> {
  ...
  await performValidation('errorMessage', {
    ...
    message: otherConsiderations.selectIfThereIsAnythingElseDefendantWantsToTellTheCourtErrorMessage,
  });
  ...
  await performValidation('errorMessage', {
    header: otherConsiderations.thereIsAProblemErrorMessageHeader,
    message: otherConsiderations.giveDetailsAboutWhatDefendantWantsToTellTheCourtErrorMessage,
  });
