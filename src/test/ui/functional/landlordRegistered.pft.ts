...
import { disputeClaimInterstitial, feedback, landlordRegistered, taskList } from '../data/page-data';
...
export async function landlordRegisteredNavigationTests(): Promise<void> {
  ...
  await performValidation('pageNavigation', landlordRegistered.saveForLaterButton, taskList.mainHeader);
}
