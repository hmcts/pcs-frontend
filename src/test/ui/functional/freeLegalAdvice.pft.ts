import { feedback, freeLegalAdvice, startNow, taskList } from '../data/page-data';
...
export async function freeLegalAdviceNavigationTests(): Promise<void> {
  ...
  await performValidation('pageNavigation', freeLegalAdvice.saveForLaterButton, taskList.mainHeader);
}
