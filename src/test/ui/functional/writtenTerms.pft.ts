import { landlordLicensed, taskList, writtenTerms } from '../data/page-data';
...
export async function writtenTermsNavigationTests(): Promise<void> {
  ...
  await performValidation('pageNavigation', writtenTerms.saveForLaterButton, taskList.mainHeader);
}
