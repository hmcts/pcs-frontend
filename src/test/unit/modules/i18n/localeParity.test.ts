...
const UNTRANSLATED_ALLOWLIST = new Set([
  ...
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.day',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.futureDate',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.missingOne',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.missingTwo',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.month',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.notRealDate',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.required',
  'respondToClaim/legalrep/tenancyDateUnknown.json::errors.date.year',
  'respondToClaim/legalrep/tenancyTypeDetails.json::correctTypeLabel',
  'respondToClaim/legalrep/tenancyTypeDetails.json::heading',
  'respondToClaim/legalrep/tenancyTypeDetails.json::legend',
  'respondToClaim/legalrep/tenancyTypeDetails.json::no',
  'respondToClaim/legalrep/tenancyTypeDetails.json::tenancyTypeOther',
  'respondToClaim/legalrep/tenancyTypeDetails.json::yes',
]);
