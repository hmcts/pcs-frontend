...
const stepName = 'non-rent-arrears-dispute';
const stepNavigation = createStepNavigation(flowConfig);

export const step: StepDefinition = {
  url: `${RESPOND_TO_CLAIM_ROUTE}/non-rent-arrears-dispute`,
  name: stepName,
  view: 'respond-to-claim/non-rent-arrears-dispute/nonRentArrearsDispute.njk',
  stepDir: __dirname,
  getController: () => {
    return createGetController( 
      'respond-to-claim/non-rent-arrears-dispute/nonRentArrearsDispute.njk',
      stepName,
      async (req: Request) => {
        ...
        return {
          ...
          includesList: t('includesList', { returnObjects: true, claimantName }),
        };
      },
      'respondToClaim'
    );
