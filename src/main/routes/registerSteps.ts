...
import { caseReferenceParamMiddleware, oidcMiddleware, professionalHeaderMiddleware } from '../middleware';
...
function buildGetMiddleware(
  ...
  const professionalHeaderMiddlewares =  [professionalHeaderMiddleware];
