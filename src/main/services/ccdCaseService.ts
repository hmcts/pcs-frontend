...
export const ccdCaseService = {
  ...
  async getExistingCaseData(accessToken: string | undefined, ccdCaseId: string): Promise<StartCallbackData> {
    ...
    try{
      const response = await http.get<StartCallbackData>(eventUrl, getCaseHeaders("eyJ0eXAiOiJKV1QiLCJraWQiOiJkQnZ3ZTE5bkFQNjVmVzVGZzB5OUZZUm1Cenc9IiwiYWxnIjoiUlMyNTYifQ..D7bI5z4rEQqef6iou_LnkF1XzLSdHsH3AkN6wmPx_5JrmVxjHONw0M7qtKq9XMZwHC7E4YC5WdpKp8XxNeyfgZZ7bj31Yq9gg64kFFkk6CjV-WwM4nAeqqcJSDfxnbpDVUo8S7Ooo6KAQ33xjKXDwHwjQseevjAdcK8Hx1gFGkUONCuWyQ_dMePpuDEXOXMkImuyfWyN1PZ0KU1rN6JFiVFf9ieh0MotFMI5TwhdgYoIF6ELLSe_JteJeLSijoyo53PsZS0xzY-u4cEKFWroT327p27ZWqS6Get6F3NHvVTMkJK6h7vGjs6bOgYVXBypjtACuR84jdJL83B4xhTlTQ"));
      return response.data; 
    } catch (error) {
    throw convertAxiosErrorToHttpError(error, 'submitEvent');
    }
